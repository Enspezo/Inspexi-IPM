...
@Module({
  imports: [ConfigModule, NotificationsModule, PlanningModule, CustomFieldsModule, ProjectsModule, QuoteTemplatesModule, EmailTemplatesModule, TasksModule],
  controllers: [QuotesController, PublicQuotesController],
  providers: [QuotesService, QuoteSchedulerService, PdfService],
