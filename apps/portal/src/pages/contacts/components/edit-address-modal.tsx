...
import { useUpdateAddress } from '../hooks/use-contacts';
...
export function EditAddressModal({
  ...
  const updateMutation = useUpdateAddress(contactId);
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Adres bewerken">
