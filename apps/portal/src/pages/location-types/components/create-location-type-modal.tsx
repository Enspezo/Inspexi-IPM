// Aanmaak-modal voor een locatie-type. Bij succes → navigeer naar de nieuwe detailpagina.
...
export function CreateLocationTypeModal({ isOpen, onClose }: Props) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Nieuw locatie-type">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <Input label="Icoon" placeholder="bijv. building" {...register('icon')} />
