...
export enum NotificationType {
  ...
  BESCHIKBAARHEID_GEWIJZIGD_DOOR_INSPECTEUR = 'BESCHIKBAARHEID_GEWIJZIGD_DOOR_INSPECTEUR',
  BESCHIKBAARHEID_GEWIJZIGD_DOOR_MANAGER = 'BESCHIKBAARHEID_GEWIJZIGD_DOOR_MANAGER',
  AI_REVIEW_GEREED = 'AI_REVIEW_GEREED',
  HERSTEL_AFGEROND = 'HERSTEL_AFGEROND',
  HERSTEL_CONFLICT = 'HERSTEL_CONFLICT',
  HERINSPECTIE_VOORSTEL = 'HERINSPECTIE_VOORSTEL',
  WEEKSTAAT_INGEDIEND = 'WEEKSTAAT_INGEDIEND',
  WEEKSTAAT_GOEDGEKEURD = 'WEEKSTAAT_GOEDGEKEURD',
  WEEKSTAAT_AFGEWEZEN = 'WEEKSTAAT_AFGEWEZEN',
  TIMER_NACHTWAKER = 'TIMER_NACHTWAKER',
}
