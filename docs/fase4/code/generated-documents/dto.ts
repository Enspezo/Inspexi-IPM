// Doel in apps/api: src/modules/generated-documents/dto/
import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';
import { IsString, IsOptional, IsEmail } from 'class-validator';

export class GenerateDocumentDto {
  @ApiPropertyOptional({ description: 'Optionele overrides bij genereren' })
  @IsOptional() @IsString()
  note?: string;
}
