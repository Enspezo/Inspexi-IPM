// Doel in apps/portal: src/pages/inspections/hooks/use-inspections.ts
// Volgt exact het use-tasks.ts patroon (TanStack Query + apiClient, query-string in de URL).
