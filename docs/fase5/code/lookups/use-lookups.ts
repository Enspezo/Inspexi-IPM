// Doel in apps/portal: src/lib/lookups.ts (of pages/lookups/hooks/use-lookups.ts)
//
...
interface LookupInput { code?: string; label?: string; color?: string | null; sortOrder?: number; isActive?: boolean }
