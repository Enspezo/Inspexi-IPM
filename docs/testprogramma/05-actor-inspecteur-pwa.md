...
| INS-38 | O | Offline login: log uit, ga offline, log in met eerder gebruikte sessie/e-mail | Toegestaan (bestaande sessie); onbekend e-mail offline → nette "alleen met eerdere sessie"-melding |
