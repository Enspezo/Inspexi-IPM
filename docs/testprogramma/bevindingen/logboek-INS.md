...
|---|---|---|
| INS-01 | PASS | Login OK; initiële sync draait (`/sync/pull` 200 + referentie-caches); dashboard-KPI's laden; 9 plannen zichtbaar; geen onafgevangen JS-fout. Kanttekening: KPI "Toegewezen 9" telt álle org-plannen, ook 3 met `assignedTo = NULL` (B-223). |
